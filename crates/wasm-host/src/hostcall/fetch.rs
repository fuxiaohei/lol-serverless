use super::host::land::http::fetching::{self, Request, Response};
use super::host::land::http::types::RequestError;
use super::{
    context::HostContext,
    host::land::http::types::{RedirectPolicy, RequestOptions},
};
use crate::hostcall::client::get_client;
use axum::body::Body;
use std::str::FromStr;
