    ...
    pub mod land {
        ...
        pub mod asyncio {
            ...
            pub mod context {
                ...
                #[doc(hidden)]
                #[macro_export]
                macro_rules! __export_land_asyncio_context_0_1_5_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "land:asyncio/context@0.1.5#is-pending"] unsafe extern "C" fn
                        export_is_pending() -> i32 { $($path_to_types)*::
                        _export_is_pending_cabi::<$ty > () } #[export_name =
                        "land:asyncio/context@0.1.5#select"] unsafe extern "C" fn
                        export_select() -> i32 { $($path_to_types)*::
                        _export_select_cabi::<$ty > () } };
                    };
                }
                #[doc(hidden)]
                pub use __export_land_asyncio_context_0_1_5_cabi;
            }
        }
        #[allow(dead_code)]
        pub mod http {
            ...
            pub mod incoming {
                ...
                #[doc(hidden)]
                #[macro_export]
                macro_rules! __export_land_http_incoming_0_1_5_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "land:http/incoming@0.1.5#handle-request"] unsafe extern "C" fn
                        ...
                        "cabi_post_land:http/incoming@0.1.5#handle-request"] unsafe
                ...
                #[doc(hidden)]
                pub use __export_land_http_incoming_0_1_5_cabi;
                #[repr(align(4))]
...
macro_rules! __export_http_handler_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::land::http::incoming::__export_land_http_incoming_0_1_5_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::land::http::incoming);
        $($path_to_types_root)*::
        exports::land::asyncio::context::__export_land_asyncio_context_0_1_5_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::land::asyncio::context); const _
        : () = { #[cfg(target_arch = "wasm32")] #[link_section =
        "component-type:wit-bindgen:0.33.0:land:worker@0.1.5:http-handler:imports and exports"]
...
edirect\x13\x04\0\x0frequest-options\x03\0\x14\x03\0\x15land:http/types@0.1.5\x05\
...
req\x01\0\x03\x04\0\x0ehandle-request\x01\x04\x04\0\x18land:http/incoming@0.1.5\x05\
\x03\x01B\x03\x01@\0\0\x7f\x04\0\x0ais-pending\x01\0\x04\0\x06select\x01\0\x04\0\
\x1aland:asyncio/context@0.1.5\x05\x04\x04\0\x1eland:worker/http-handler@0.1.5\x04\
\0\x0b\x12\x01\0\x0chttp-handler\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
\x0dwit-component\x070.218.0\x10wit-bindgen-rust\x060.33.0";
        };
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.33.0:land:worker@0.1.5:http-handler-with-all-of-its-exports-removed:encoded world"]
#[doc(hidden)]
...
\x06manual\x05error\x04\0\x0fredirect-policy\x03\0\x12\x01r\x02\x07timeouty\x08r\
edirect\x13\x04\0\x0frequest-options\x03\0\x14\x03\0\x15land:http/types@0.1.5\x05\
\0\x04\0>land:worker/http-handler-with-all-of-its-exports-removed@0.1.5\x04\0\x0b\
