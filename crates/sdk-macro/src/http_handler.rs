...
macro_rules! __export_http_handler_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.34.0:land:worker@0.1.5:http-handler:imports and exports"]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.34.0:land:worker@0.1.5:http-handler-with-all-of-its-exports-removed:encoded world"]
#[doc(hidden)]
