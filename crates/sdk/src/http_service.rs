...
pub mod land {
    ...
    pub mod asyncio {
        ...
        pub mod asyncio {
            ...
            pub type Handle = super::super::super::land::asyncio::types::Handle;
            #[allow(unused_unsafe, clippy::all)]
            /// new async task handle
            pub fn new() -> Result<Handle, ()> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "land:asyncio/asyncio@0.1.5")]
                    extern "C" {
                        #[link_name = "new"]
            ...
            #[allow(unused_unsafe, clippy::all)]
            /// new sleep time task handle and sleep
            pub fn sleep(ms: u32) -> Result<Handle, ()> {
                unsafe {
                    #[repr(align(4))]
                    struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
                    let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
        ...
        pub mod body {
            ...
            pub fn read(
                ...
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "land:http/body@0.1.5")]
                    extern "C" {
                        #[link_name = "read"]
        ...
        pub mod fetching {
            ...
            pub fn send_request(
                ...
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "land:http/fetching@0.1.5")]
                    extern "C" {
...
\x04\0\x0anew-stream\x01\x0d\x03\0\x14land:http/body@0.1.5\x05\x02\x02\x03\0\0\x07\
...
land:http/fetching@0.1.5\x05\x07\x01B\x02\x01y\x04\0\x06handle\x03\0\0\x03\0\x18\
land:asyncio/types@0.1.5\x05\x08\x02\x03\0\x03\x06handle\x01B\x0d\x02\x03\x02\x01\
